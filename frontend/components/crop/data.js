const cropData = {
  wheat: {
    ...
    benefits: {
      ...
      potato:
        "Potatoes break disease cycles and utilize different soil layers.",
    },
    organicFertilizers: [
      {
        name: "Compost",
        description: "Rich in nutrients and improves soil structure.",
      },
      {
        name: "Green Manure",
        description: "Plant cover crops like clover to enrich soil.",
      },
      {
        name: "Bone Meal",
        description: "High in phosphorus, good for root development.",
      },
    ],
    soil: "loamy",
    region: "temperate",
  ...
  rice: {
    ...
    benefits: {
      pulses:
        "Pulses (like moong or urad) fix nitrogen and improve soil fertility after rice.",
      wheat:
        "Wheat-rice is a traditional rotation in Indo-Gangetic plains, different water requirements help soil recovery.",
      mustard:
        "Mustard has deep roots that break hardpan and adds organic matter to soil.",
    },
    organicFertilizers: [
      {
        name: "Jeevamrut",
        description:
          "Traditional bio-fertilizer made from cow dung, urine, and local ingredients.",
      },
      {
        name: "Green Manure",
        description:
          "Dhaincha or Sesbania for nitrogen fixation before rice transplanting.",
      },
      {
        name: "Azolla",
        description: "Aquatic fern that fixes nitrogen in rice paddies.",
      },
    ],
    soil: "clay",
    region: "tropical",
  ...
  sugarcane: {
    ...
    benefits: {
      ...
      potato:
        "Different root system helps break pest cycles and utilize nutrients.",
    },
    organicFertilizers: [
      {
        name: "Press Mud Compost",
        description: "Sugarcane industry byproduct rich in nutrients.",
      },
      {
        name: "Farm Manure",
        description: "Well-decomposed cow dung manure for sustained nutrition.",
      },
      {
        name: "Bone Meal",
    ...
    organicFertilizers: [
      {
        ...
        description: "Enhances nitrogen fixation in pulse crops.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
      },
      {
        name: "Ghanjeevamrut",
        description: "Solid form of Jeevamrut, rich in beneficial microbes.",
      },
    ],
    soil: "sandy",
    region: "subtropical",
  ...
  cotton: {
    ...
    organicFertilizers: [
      {
        name: "Neem Oil Cake",
        description: "Natural pest deterrent and nutrient source.",
      },
      {
        name: "Composted Manure",
        description: "Well-rotted manure for slow release of nutrients.",
      },
      {
        name: "Beejamrut",
        description: "Traditional seed treatment for better germination.",
      },
    ],
    soil: "sandy",
    region: "tropical",
  ...
  groundnut: {
    ...
    benefits: {
      ...
      "pearl-millet":
        "Bajra/pearl-millet has deep roots and drought tolerance.",
      maize: "Maize benefits from nitrogen fixed by groundnut.",
    },
    organicFertilizers: [
      {
        name: "Phosphate Rich Organic Manure",
        description: "Enhances pod development and oil content.",
      },
      {
        name: "Trichoderma Enriched FYM",
        description: "Protects from soil-borne diseases.",
      },
      {
        name: "Karanj Cake",
        description: "Natural pest repellent and nutrient source.",
      },
    ],
    soil: "sandy",
    region: "tropical",
  ...
  maize: {
    ...
    organicFertilizers: [
      {
        name: "Composted Manure",
        description: "High in nitrogen needed for corn growth.",
      },
      {
        name: "Cover Crops",
        description:
          "Plant winter rye to prevent erosion and add organic matter.",
      },
      {
        name: "Worm Castings",
        description: "Rich in microbes and nutrients for soil health.",
      },
    ],
    soil: "loamy",
    region: "tropical",
  ...
  sorghum: {
    ...
    benefits: {
      ...
      wheat: "Wheat utilizes different soil layers and breaks disease cycle.",
      groundnut:
        "Groundnut benefits from improved soil structure after sorghum.",
    },
    organicFertilizers: [
      {
        name: "Farm Manure",
      ...
      },
      {
        name: "Rock Phosphate",
        description:
          "Natural source of phosphorus for better root development.",
      },
    ],
    soil: "sandy",
    region: "arid",
  ...
  "pearl-millet": {
    ...
    benefits: {
      ...
      wheat: "Wheat utilizes different soil layers and breaks disease cycle.",
      groundnut:
        "Groundnut benefits from improved soil structure after pearl millet.",
    },
    organicFertilizers: [
      {
        name: "Farm Manure",
  ...
  chickpea: {
    ...
    benefits: {
      ...
      sorghum:
        "Sorghum utilizes residual nitrogen and has different pest profile.",
      cotton: "Cotton benefits from improved soil structure after chickpea.",
    },
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in chickpea.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  mustard: {
    ...
    benefits: {
      ...
      maize:
        "Maize utilizes residual nutrients and has different pest profile.",
    },
    organicFertilizers: [
      {
        name: "Farm Manure",
  ...
  moong: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in moong.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  soybean: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in soybean.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  alfalfa: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in alfalfa.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  legumes: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in legumes.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  cowpea: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in cowpea.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  "mung bean": {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in mung bean.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  pigeonpea: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in pigeonpea.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  arhar: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in arhar.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  tur: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in tur.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  "tur dal": {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in tur dal.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  lobia: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in lobia.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
  ...
  chawli: {
    ...
    organicFertilizers: [
      {
        name: "Rhizobium Culture",
        description: "Enhances nitrogen fixation in chawli.",
      },
      {
        name: "Rock Phosphate",
        description: "Natural source of phosphorus for better nodulation.",
