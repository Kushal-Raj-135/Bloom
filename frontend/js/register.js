document.addEventListener("DOMContentLoaded", () => {
  ...
  const toggleConfirmPassword =
    document.querySelectorAll(".toggle-password")[1];
  ...
  if (storedToken && storedUser) {
    ...
    try {
      ...
      // If token is invalid, clear it and continue with registration
  ...
  if (registerForm) {
    registerForm.addEventListener("submit", async (e) => {
      ...
      if (passwordInput) {
        isValid =
          validateField(passwordInput, validatePassword, true) && isValid;
      }
